...
public class Test {
    ...
    private static class MessagesReader implements ReadFile<String> {
    ...
    public static void main(String[] args) throws IOException {
        BufferedReader br = new BufferedReader(new FileReader("/home/maciezie/projects/tmp/advent-of-code-2020/src/main/resources/day19/02.txt"));
